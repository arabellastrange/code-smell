...
public class Run {
     ...
     * "src/main/java/testcode/Couplers/MessageChains/Intermediate.java", "src/main/java/testcode/Couplers/MessageChains/Parent.java","src/main/java/testcode/Bloaters/Grid.java", "src/main/java/testcode/FalsePositives/BoxingTheCompass.java",
     ...
     **/
    private static final String[] FILE_PATHS = new String[]{"src/main/java/testcode/Abusers/RefusedBequest/Account.java", "src/main/java/testcode/Abusers/RefusedBequest/ChqAcc.java",
            "src/main/java/testcode/Abusers/RefusedBequest/SavingsAcc.java"};
